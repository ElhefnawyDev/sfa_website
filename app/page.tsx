        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <motion.button
              ...
              className="md:hidden p-2 rounded-lg bg-blue-100 text-blue-700"
            >
              {isMenuOpen ? (
                <X className="w-6 h-6" />
              ) : (
              ...
              <div className="container mx-auto px-4 py-4 space-y-2">
                {navItems.map((item, index) => (
                  <motion.button
                    ...
                    transition={{ delay: index * 0.1 }}
                    onClick={() => scrollToSection(item.id)}
                    className="flex items-center space-x-3 w-full px-4 py-3 rounded-lg text-left transition-colors hover:bg-blue-50"
                  >
              ...
              <div className="mx-auto max-w-6xl mt-12">
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                  ...
                  <div className="bg-gradient-to-r from-cyan-500 via-blue-600 to-blue-700 text-white">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-0">
                      ...
                      <div className="p-6 border-r border-white/20 text-center">
                        <div className="space-y-2">
                          <h3 className="text-lg font-semibold">Small SME</h3>
                        </div>
                      </div>
                      <div className="p-6 border-r border-white/20 text-center relative">
                        <div className="space-y-2">
                          <h3 className="text-lg font-semibold">Medium SME</h3>
                        </div>
                      </div>
                      <div className="p-6 text-center">
                        <div className="space-y-2">
                          <h3 className="text-lg font-semibold">Large SME</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="divide-y divide-gray-100">
                    {/* User Limit Row */}
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-0 hover:bg-gray-50 transition-colors">
                      ...
                      <div className="p-6 border-r border-gray-100 text-center bg-blue-50">
                        <span className="text-gray-700 font-medium">
                          Up to 25 users
                        </span>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-0 hover:bg-gray-50 transition-colors">
                      ...
                      <div className="p-6 border-r border-gray-100 text-center">
                        <div className="flex items-center justify-center space-x-2">
                          ...
                          <span className="text-gray-700">Cloud included</span>
                        </div>
                      </div>
                      <div className="p-6 border-r border-gray-100 text-center bg-blue-50">
                        <div className="flex items-center justify-center space-x-2">
